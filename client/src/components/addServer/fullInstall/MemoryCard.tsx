...
// Memory allocation card used on the Performance step of Full Install.
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          {memory.detecting ? (
            ...
            memory.systemRam && (
              <Badge variant="outline">{memory.systemRam.totalGB} GB RAM detected</Badge>
            )
          )}
        </div>
      </CardHeader>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-mono font-medium">{memory.min}GB</span>
            </div>
            <Slider
              value={[memory.min]}
              onValueChange={([val]) => {
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-mono font-medium">{memory.max}GB</span>
            </div>
            <Slider
              value={[memory.max]}
              onValueChange={([val]) => {
