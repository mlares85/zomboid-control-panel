...
// Step 3 state: RCON credentials, memory allocation, and advanced runtime options.
export function usePerformanceStep() {
  ...
  // Load previously saved memory/port settings (memory stored in MB, clamp to slider range)
  useEffect(() => {
